...
$(call inherit-product, device/reallytek/$(MTK_TARGET_PROJECT)/device.mk)
...
PRODUCT_NAME := full_rlk6737m_open_n
PRODUCT_DEVICE := rlk6737m_open_n
PRODUCT_MODEL := rlk6737m_open_n
PRODUCT_POLICY := android.policy_phone
PRODUCT_BRAND := alps

ifeq ($(TARGET_BUILD_VARIANT), eng)
KERNEL_DEFCONFIG ?= rlk6737m_open_n_debug_defconfig
else
KERNEL_DEFCONFIG ?= rlk6737m_open_n_defconfig
endif
PRELOADER_TARGET_PRODUCT ?= rlk6737m_open_n
LK_PROJECT ?= rlk6737m_open_n
TRUSTY_PROJECT ?= rlk6737m_open_n
